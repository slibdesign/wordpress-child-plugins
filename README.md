# WordPress Child Plugins

A framework for WordPress plugin modification

WordPress child plugins that work with parent plugins from WordPress.org. Demo: [childpluginwp.com](https://childpluginwp.com)
...
Code is matched to a specific WordPress plugin (parent plugin)
